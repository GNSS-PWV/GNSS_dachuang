...
def main():
    ...
    output_dir = r"/share/home/u23114/tj23114/packages/dachuang_pwv/Ts_Tm/tm_result"
    ...
    try:
        ...
        target_names = ['Tm']
        print(f"序列形状：X={X_seq.shape}, y={y_seq.shape}（目标：Tm）", flush=True)
        ...
        print("最佳超参数:")
        print("  learning_rate: 0.0006725958878132012")
        print("  hidden_size: 115")
        print("  dropout: 0.1015389027244976")
        print("  weight_decay: 1.529672986869665e-06")
        print("  num_layers: 2")
        print("  batch_size: 64")

        train_dataset = TimeSeriesDataset(X_train, y_train, augment=False)
        ...
        best_params = {
            'learning_rate': 0.0006725958878132012,
            'hidden_size': 115,
            'dropout': 0.1015389027244976,
            'weight_decay': 1.529672986869665e-06,
            'num_layers': 2
        }
