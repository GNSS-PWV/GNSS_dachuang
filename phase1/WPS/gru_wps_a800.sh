#!/bin/bash
#SBATCH --job-name=gru_wps_train
#SBATCH --comment="train_gru_wps(gru) on L40 GPU"
...
#SBATCH --output=/share/home/u23114/tj23114/packages/dachuang_pwv/WPS/%x_%j.out
#SBATCH --error=/share/home/u23114/tj23114/packages/dachuang_pwv/WPS/%x_%j.err
...
# 执行训练脚本
python /share/home/u23114/tj23114/packages/dachuang_pwv/WPS/gru_wps_1.py
